...
<div class="container my-5">
    <div class="row">
        <div class="col-md-10 mx-auto d-md-flex align-items-center justify-content-between">
            ...
            <form action="/home">
                <div class="input-group">
                        <input type="search" id="search" name="search" class="form-control" placeholder="search polling....." value="{{ request('search') }}" />
                    <button id="search-button" type="submit" class="btn btn-primary">
                        <i class="fas fa-search"></i>
                    </button>
                </div>
        ...
        <div class="modal-body">
            ...
            <div class="text-center mb-5">
                <div class="d-flex justify-content-center mb-3 ">
                    <img src="{{ asset('img/dpkFavicon.png') }}" alt="logo radar depok" style="width: 100px;">
                  </div>
                  <h4>Polling Radar Depok</h4>
                  <p>Login Options</p>
            </div>
