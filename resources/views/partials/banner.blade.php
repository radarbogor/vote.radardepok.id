...
<div class="row d-flex flex-column-reverse flex-md-row align-items-center py-3 py-md-5 col-md-10 mx-auto">
    <div class="col-md-6 px-0 mt-md-0 text_bnr">
        <h1 class="fw-bold" data-aos="fade-up" data-aos-duration="800">Selamat Datang<br>di Polling Radar Depok</h1>
    ...
    <div class="col-md-6 px-0">
        <img src="img/DpkPoll.png" style="filter: drop-shadow(-3px 3px 3px #14141466);" alt="" data-aos="fade-right" data-aos-duration="1000" class="  img-fluid">
    </div>
</div>
</div>
